 ...
 * @version   CVS: $Id: FunctionCommentSniff.php 302088 2010-08-11 01:52:10Z squiz $
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class phpCSDynacase_Sniffs_Documentation_FunctionDocumentationSniff implements PHP_CodeSniffer_Sniff
{


    public $optionnalTags = array(
        'brief'
    );
    /**
    ...
    protected function processUnknownTags($commentStart, $commentEnd)
    {
	  ...
	  if (! in_array($errorTag['tag'], $this->optionnalTags) ) {
